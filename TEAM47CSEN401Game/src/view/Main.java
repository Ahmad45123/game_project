...
public class Main {
	...
	public static void main(String args[]) {
		...
		JLabel myLabel = new JLabel("Start Screen");
		myLabel.setBounds(w / 2, h / 10, w / 4, h / 25);
		...
		player_name.setBounds(w / 2, h / 5, w / 4, h / 20);
		city_name.setBounds(w / 2, h / 5 + 100, w / 4, h / 20);
